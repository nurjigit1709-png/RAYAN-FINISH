...
export default function FolderPage({ id }: { id: string }) {
  ...
  const handleCreateFolder = async () => {
    ...
    queryClient.invalidateQueries({
      queryKey: getListFoldersQueryKey({ parentId: folderId }),
    });
  ...
  const uploadFiles = async (fileList: FileList | null) => {
    ...
    const token =
      localStorage.getItem("rayan_token") ||
      sessionStorage.getItem("rayan_token");
    ...
    try {
      ...
      queryClient.invalidateQueries({
        queryKey: getListFilesQueryKey({ folderId }),
      });
            ...
            {canUpload && (
              <>
                <Button
                  ...
                  data-testid="btn-create-subfolder"
                >
